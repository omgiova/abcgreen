          ...
          <div className="grid grid-cols-2 gap-3 py-2">
            ...
            <div className="rounded-xl border bg-muted/20 p-4 space-y-2 hover:bg-muted/30 transition-colors">
              ...
              <div className="flex items-center gap-1">
                <span className="text-base sm:text-2xl font-bold text-foreground">R$</span>
                <input
                  type="number"
                  min="0"
                  step="0.01"
                  ...
                  className="w-full bg-transparent p-0 text-base sm:text-2xl font-bold text-foreground outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                />
              </div>
            </div>
            ...
            <div className="rounded-xl border bg-muted/20 p-4 space-y-2 hover:bg-muted/30 transition-colors">
              ...
              <div className="flex items-center gap-1">
                <input
                  ...
                  className={cn(
                    "w-full bg-transparent p-0 text-base sm:text-2xl font-bold outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none",
                    parseFloat(calcRoi) >= 0 ? "text-success" : "text-destructive"
                  )}
                />
                <span className={cn("text-base sm:text-2xl font-bold", parseFloat(calcRoi) >= 0 ? "text-success" : "text-destructive")}>%</span>
              </div>
            </div>
            ...
            <div className="rounded-xl border bg-muted/20 p-4 space-y-2 hover:bg-muted/30 transition-colors">
              ...
              <div className="flex items-center gap-1">
                <span className="text-base sm:text-2xl font-bold text-muted-foreground">R$</span>
                <input
                  type="number"
                  min="0"
                  step="0.01"
            ...
            {(() => {
              ...
              return (
                <div className={cn(
                  ...
                  <div className="flex items-center gap-1">
                    <span className={cn("text-base sm:text-2xl font-bold", isPositive ? "text-success" : "text-destructive")}>R$</span>
                    <p className={cn(
                  ...
                  <>
                    ...
                    <div className={cn("rounded-xl border p-4 space-y-1", isPositiveLucro ? "bg-success/10 border-success/30" : "bg-destructive/10 border-destructive/30")}>
                      ...
                      <div className="flex items-center gap-0.5">
                        ...
                        />
                        <span className={cn("text-base sm:text-2xl font-bold", isPositiveLucro ? "text-success" : "text-destructive")}>%</span>
                      </div>
                    </div>
                    ...
                    <div className={cn("rounded-xl border p-4 space-y-1", isPositiveLucro ? "bg-success/10 border-success/30" : "bg-destructive/10 border-destructive/30")}>
                      ...
                      <div className="flex items-center gap-1">
                        <span className={cn("text-base sm:text-2xl font-bold", isPositiveLucro ? "text-success" : "text-destructive")}>R$</span>
                        <p className={cn("text-base sm:text-2xl font-bold", isPositiveLucro ? "text-success" : "text-destructive")}>
                    ...
                    <div className="col-span-3 grid gap-3 grid-cols-3">
                      {/* Qtd de produtos */}
                      <div className="rounded-xl border bg-muted/20 p-4 space-y-1 hover:bg-muted/30 transition-colors">
                        <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Quant.</p>
                        <input
                          type="number"
                          min="1"
                          step="1"
                      ...
                      <div className="rounded-xl border bg-muted/10 p-4 space-y-1">
                        ...
                        <div className="flex items-center gap-1">
                          <span className="text-base sm:text-2xl font-bold text-destructive">R$</span>
                          <p className="text-base sm:text-2xl font-bold text-destructive">
              ...
              return (
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className={cn("rounded-xl border p-4 space-y-1", isPositiveShopee ? "bg-success/10 border-success/30" : "bg-destructive/10 border-destructive/30")}>
                    ...
                    <div className="flex items-center gap-1">
                      <span className={cn("text-base sm:text-2xl font-bold", isPositiveShopee ? "text-success" : "text-destructive")}>R$</span>
                      <input
                        type="number"
                        step="0.01"
                        value={shopeeLiquido}
